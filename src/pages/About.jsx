...
// import StatsComponents from '../component/core/AboutPage/StatsComponents';
// import LearningGrid from '../component/core/AboutPage/LearningGridArray';
...
// const About = () =>{
//   return (
//     <div className='max-auto max-w-maxContent w-11/12 ml-52 -mr-32'>
        
//         {/* section 1*/}
//         <section className='relative max-auto flex-w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
//             <header className='max-auto py-20 text-4xl font-semibold lg:w-[70%]'>
//                 driving Innovation in Online Education for a
//                 <HighlightText text={'Brighter Future'}/>
//                 <p className='max-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]'>
//                     Studynotion is at the forefront of driving innovatoin in online educatoin. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learing community.
//                 </p>
//             </header>
            
//             <div className='sm:h-[70px] lg:h-[150px] '></div>
//             <div className='absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 lg:gap-5'>
...
//         {/* section 2 */}
//         <section className='border-b border-r-richblue-700 '>
//             <div className='max-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500'>
...
//             {/* Founding story div */}
//             <div className='flex flex-col w-11/12 max-w-maxContent justify-between gap-10 text-richblack-500'>
...
//           {/* section 6 */}
//           <section className='relative max-auto my-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblue-900 text-white'>
...
import Quote from '../component/core/AboutPage/Quote'
import FoundingStory from "../Asset/Image/FoundingStory.png"
import StatsComponent from '../component/core/AboutPage/StatsComponents'
import LearningGrid from '../component/core/HomePage/LearningLanguageSection'
import ContactFormSection from '../component/core/ContactUsPage/ContactUsForm'
import Footer from '../component/common/Footer'
